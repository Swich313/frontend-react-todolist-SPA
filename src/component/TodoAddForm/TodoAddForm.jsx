...
const TodoAddForm = () => {
    ...
    const {
        ...
        reset: titleReset,
    } = useInput(value => value.length >= 5 && value.length <= 100);                          //backend validation title length min: 5, max: 100
    ...
    } = useInput(value => value.length >= 10 && value.length <= 256);                          //backend validation description length min: 10, max: 256
    ...
    // if(isResetInputs){
    //     resetInputs();
    //     dispatch(notResetInputs());
    // }
    console.log({isResetInputs})
        ...
        <Card styles={{'padding': '150px'}}>
            <Form method="post" className={classes.form}>
                ...
                <div className={todoTypeClassNames}>
                    ...
                    {todoType === 'AddNewType' && <input name="todoType"
